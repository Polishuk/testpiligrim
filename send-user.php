...
<head>
 <title>Test piligrim</title>
	...
	<?php
		if (($_GET['username']) == true && ($_GET['role_id']) == true  ){
			...
			$result = $mysqli->query("INSERT INTO ".$db_table." (username,role_id) VALUES ('$username','$role_id')");
			...
			echo "<div class='bd_error'>Заполните поле 'имя пользователя' </div>";
		}
	?>
